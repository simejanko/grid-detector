...
namespace grid_detector {
    ...
    const std::string DEBUG_IMAGE_TITLES[] = {"Blurred image", "Color mask", "Edges", "Lines",
...
/** Draws hough lines on the image */
    ...
    GridDetector::GridDetector(cv::Scalar low_HSV_thresh, cv::Scalar high_HSV_thresh,
            ...
            morph_close_element_(
                    cv::getStructuringElement(cv::MORPH_RECT, cv::Size(morph_close_size, morph_close_size))),
