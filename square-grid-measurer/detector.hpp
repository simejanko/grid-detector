...
public:
    explicit SquareGridDetector(cv::Scalar low_HSV_thresh, cv::Scalar high_HSV_thresh, int min_visible_lines = 3,
                                ...
                                double canny_high_tresh_mul = 0.6, int nms_strength=5, int gauss_window_size = 5,
                                double gauss_sigma = 1, int morph_close_size = 9, bool draw_debug = false,
                                float debug_scale = 0.5);
